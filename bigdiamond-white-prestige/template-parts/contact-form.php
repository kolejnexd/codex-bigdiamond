...
<label for="bdwp-name"><?php esc_html_e( 'Imię', 'bigdiamond-white-prestige' ); ?> <span aria-hidden="true" title="<?php esc_attr_e( 'Wymagane', 'bigdiamond-white-prestige' ); ?>">*</span></label>
<input type="text" id="bdwp-name" name="bdwp-name" autocomplete="name" required aria-required="true" />
</div>
<div class="bdwp-form__group">
<label for="bdwp-email"><?php esc_html_e( 'E-mail', 'bigdiamond-white-prestige' ); ?> <span aria-hidden="true" title="<?php esc_attr_e( 'Wymagane', 'bigdiamond-white-prestige' ); ?>">*</span></label>
<input type="email" id="bdwp-email" name="bdwp-email" autocomplete="email" required aria-required="true" />
</div>
<div class="bdwp-form__group">
<label for="bdwp-message"><?php esc_html_e( 'Twoja wiadomość', 'bigdiamond-white-prestige' ); ?> <span aria-hidden="true" title="<?php esc_attr_e( 'Wymagane', 'bigdiamond-white-prestige' ); ?>">*</span></label>
...
<dd id="faq-panel-<?php echo esc_attr( $index ); ?>" class="bdwp-faq__panel" hidden>
