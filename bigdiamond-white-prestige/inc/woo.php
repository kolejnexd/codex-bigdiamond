...
function bigdiamond_white_prestige_recently_viewed_products(): void {
	...
	$query = new WP_Query(
		array(
				...
				'no_found_rows'       => true, // ⚡ Optimize: Skip SQL_CALC_FOUND_ROWS since pagination is not needed
				'ignore_sticky_posts' => true, // ⚡ Optimize: Skip sticky post checks for performance
		)
	);
