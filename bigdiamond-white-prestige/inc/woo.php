...
function bigdiamond_white_prestige_recently_viewed_products(): void {
	...
	$query = new WP_Query(
		array(
			...
			'no_found_rows'       => true, // ⚡ Bolt: Skip expensive SQL_CALC_FOUND_ROWS calculation since pagination is not needed
			'ignore_sticky_posts' => true, // ⚡ Bolt: Skip sticky post checks for better performance
		)
	);
