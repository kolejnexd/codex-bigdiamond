...
function bigdiamond_white_prestige_recently_viewed_products(): void {
	...
	$query = new WP_Query(
		array(
			...
			// Optimize: Skip expensive SQL_CALC_FOUND_ROWS since we don't paginate recently viewed products
			'no_found_rows'       => true,
			// Optimize: Skip sticky post checks which require additional queries
