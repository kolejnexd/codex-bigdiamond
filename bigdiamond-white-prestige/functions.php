...
function bdwp_save_engraving_to_cart_item( array $cart_item_data, int $product_id, int $variation_id ): array {
	// Security: Validate type and apply wp_unslash to prevent double-escaping or data integrity issues
	if ( isset( $_POST['bdwp_engraving_text'] ) && is_string( $_POST['bdwp_engraving_text'] ) && '' !== trim( $_POST['bdwp_engraving_text'] ) ) {
